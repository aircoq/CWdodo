                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="admin_status">
                                ...
                                <option value="1"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">未审核</font></font></option>
                        ...
                        <div class="form-group">
                            ...
                            <p class="help-block">不大于500k，接收png，</p>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox"> 同意公司注册协议
                            </label>
                        </div>
                    </div>
                    <!-- /.box-body -->
