            ...
            <section class="content container-fluid">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <a class="btn btn-box-tool btn-xs"  href="javascript:;" onclick="layer_show('添加','{{ url('admin/goods/create').'?step=1&id=1' }}','1200','800')" id="a-admin-add">
    ...
    <script>
        $(function (){
            ...
            $('#dataTables').DataTable({
                ...
                "ajax": {
                    "url": "{{ url('admin/goods/') }}",// 服务端uri地址，显示数据的uri
