...
@section('content')
    <div class="cl-sm-12">
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" id="form-table1" action="{{ url('admin/appointment/'.$appointment->id) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('put') }}
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" style="width:70%;" name="appointment_type" id="appointment_type">
                                <option value="0" id='appointment_type0'>寄养</option>
                                <option value="1" id='appointment_type1'>美容</option>
                                <option value="2" id='appointment_type2'>洗澡</option>
                                <option value="3" id='appointment_type3'>护理</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" style="width:70%;display:inline;" placeholder="预约时间" name="start_at" value="{{ date("Y-m-d H:i",$appointment->start_at) }}"/>
                    </div>
                </div>
                <div class="form-group foster">
                    <label class="col-sm-2 control-label">结束时间</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" style="width:70%;display:inline;" placeholder="结束时间" name="end_at" value="{{ date("Y-m-d H:i",$appointment->end_at) }}"/>
                    </div>
                </div>
                <div class="form-group foster">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" style="width:70%;" name="food_id">
                            @foreach ($food as $v)
                                <option value="{{ $v['id'] }}" id="food{{ $v['id'] }}">
                                    {{ $v['food_name'] }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" style="width:70%;display:inline;" placeholder="姓名" name="user_name" value="{{ $appointment->user_name }}"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="tel" class="form-control" style="width:70%;display:inline;" placeholder="手机"  name="user_phone" id="user_phone" value="{{ $appointment->user_phone }}"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group pickup_address">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="tel" class="form-control" style="width:39%;display:inline;" placeholder="详细地址"  name="address" id="address" value="{{ $appointment->address }}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">备注</label>
                    <div class="col-sm-10">
                        <textarea class="textarea" style="width: 70%; height: 150px; font-size: 14px;" placeholder="备注" name="mark_up">{{ $appointment->mark_up }}</textarea>
                    </div>
                </div>
            </div>
            <!-- /.box-body -->
...
@section('script')
    ...
    <script>
        $(function(){
            $('#appointment_type{{$appointment->appointment_type}}').attr('selected','selected');
            $('#food{{$appointment->food_id}}').attr('selected','selected');
            $('#sex{{$appointment->sex}}').attr('selected','selected');
            $('#is_pickup{{$appointment->is_pickup}}').attr('selected','selected');
            /***编写省市县三级联动*/
            var i, j, k;
