...
@section('script')
    ...
    <script>
        ...
        var playSound = function () {
            ...
            {
                //IE内核浏览器
                var strEmbed = '<embed name="embedPlay" src="{{ url('system_static_file/sound/xiadingdan_qianniu.mp3') }}" autostart="true" hidden="true" loop="false"></embed>';
            ...
            {
                //非IE内核浏览器
                var strAudio = "<audio id='audioPlay' src='system_static_file/sound/xiadingdan_qianniu.mp3' hidden='true'>";
