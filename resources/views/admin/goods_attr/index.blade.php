            ...
            <section class="content container-fluid">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">商品属性表</h3>
                        <a class="btn btn-box-tool btn-xs"  href="javascript:;" onclick="admin_add('添加','{{ url('admin/goods_attr/create')  }}','800','500')" id="a-admin-add">
                            <font style="vertical-align:inherit; color:#3c8dbc;"><font style="font-size:14px;"><i class="fa fa-fw fa-plus"></i>新增属性</font></font>
                        </a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
    ...
    <script>
        $(function (){
            ...
            $('#dataTables').DataTable({
                ...
                "ajax": {
                    "url": "{{ url('admin/goods_attr/list') }}",// 服务端uri地址，显示数据的uri
