        ...
        <form class="form-horizontal" id="form-admin-add" action="{{ url('admin/goods_attr')  }}" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="textarea" style="width: 70%; height: 50px; font-size: 14px;" placeholder="属性的可选值，当属性的录入方式为列表选择的时候对应的可选值，使用逗号进行分割" name="attr_values" id="attr_values"></textarea>
                    </div>
                </div>
                <div class="form-group">
