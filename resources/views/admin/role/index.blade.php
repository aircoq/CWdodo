            ...
            <section class="content container-fluid">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <a class="btn btn-box-tool btn-xs"  href="javascript:;" onclick="admin_add('添加','{{ url('admin/role/create')  }}','800','500')" id="a-admin-add">
                            <font style="vertical-align:inherit; color:#3c8dbc;"><font style="font-size:14px;"><i class="fa fa-fw fa-user-plus"></i>添加新角色</font></font>
                        </a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
    ...
    <script>
        $(function (){
            ...
            $('#dataTables').DataTable({
                ...
                "ajax": {
                    "url": "{{ url('admin/role') }}",// 服务端uri地址，显示数据的uri
                ...
                'createdRow':function ( row,data,dataIndex ) {
                    ...
                    $(row).find('td:eq(-1)').html(
                        ...
                        '</button>' +
                        '<button type="button" class="btn btn-danger" onclick="admin_del(this,\''+data.id+'\',\''+data.role_name+'\')" >' +
                        '<font style="vertical-align: inherit;"><font style="vertical-align: inherit;">删除</font></font>' +
                        '</button>' +
                        '<button type="button" class="btn btn-warning" onclick="admin_restore(this,\''+data.id+'\',\''+data.role_name+'\')">' +
