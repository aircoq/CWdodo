...
@section('content')
            <div class="cl-sm-12">
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" id="form-admin-add" action="{{ url('admin/auth')  }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">模块/权限名称</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" style="width:70%;display:inline;" placeholder="权限名称，显示在菜单栏的名称" name="auth_name" id="auth_name"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">所属控制器</label>
                            <div class="col-sm-10">
                                <input type="tel" class="form-control" style="width:70%;display:inline;" placeholder="路由中的控制器"  name="auth_controller" id="auth_controller"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">所属控制器下的方法</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" style="width:70%;display:inline;" placeholder="路由下的方法名" name="auth_action" id="auth_action">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="textarea" style="width: 70%; height: 200px; font-size: 14px;" placeholder="管理员的备注" name="auth_desc"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
