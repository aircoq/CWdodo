            ...
            <section class="content container-fluid">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <a class="btn btn-box-tool btn-xs"  href="javascript:;" onclick="admin_add('添加','{{ url('admin/auth/create')  }}','800','500')" id="a-admin-add">
                            <font style="vertical-align:inherit; color:#3c8dbc;"><font style="font-size:14px;"><i class="fa fa-fw fa-user-plus"></i>新建权限</font></font>
                        </a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
    ...
    <script>
        $(function (){
            ...
            $('#dataTables').DataTable({
                ...
                "ajax": {
                    "url": "{{ url('admin/auth') }}",// 服务端uri地址，显示数据的uri
                ...
                'createdRow':function ( row,data,dataIndex ) {
                    ...
                    $(row).find('td:eq(-1)').html(
                        '<div class="btn-group">' +
                        '<button type="button" class="btn btn-info" onclick="admin_edit(' + '\'编辑\',\'/admin/auth/'+data.id+'/edit\',\''+data.id+'\')" >' +
                        '<font style="vertical-align: inherit;"><font style="vertical-align: inherit;">编辑</font></font>' +
                        '</button>' +
                        '<button type="button" class="btn btn-danger" onclick="admin_del(this,\''+data.id+'\',\''+data.auth_name+'\')" >' +
                        '<font style="vertical-align: inherit;"><font style="vertical-align: inherit;">删除</font></font>' +
                        '</button>' +
                        '<button type="button" class="btn btn-warning" onclick="admin_restore(this,\''+data.id+'\',\''+data.auth_name+'\')">' +
        ...
        function admin_del(obj,id,name){
            layer.confirm('<font color="red" >危险！确定删除当前(<b>'+name+'<b/>)吗？</font>',function(index){
