...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>系统管理员</b>V1.0</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">欢迎登陆</p>
    <form action="{{ url('admin/login') }}" method="post" id="form-admin-log">
      {{ csrf_field() }}
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="账号或手机号码" name="username">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" name="online" id="online" value="true"> 记住登陆
            </label>
          </div>
        </div>
        <!-- /.col -->
