...
@section('content')
    <form class="form-horizontal" id="form-add" action="{{ url('admin/service/'.$service->id) }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    {{ method_field('put') }}
    <!-- /.box-header -->
        <!-- form start -->
        ...
        <div class="box-body">
            <div class="cl-sm-12">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" style="width:70%;display:inline;" placeholder="服务名称" name="service_name" value="{{ $service->service_name }}"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="col-sm-3 radio">
                            <label>
                                <input type="radio" name="pet_category" value="0" id="pet_category0">其他
                            </label>
                        </div>
                        <div class="col-sm-3 radio">
                            <label>
                                <input type="radio" name="pet_category" value="1" id="pet_category1">狗
                            </label>
                        </div>
                        <div class="col-sm-3 radio">
                            <label>
                                <input type="radio" name="pet_category" value="2" id="pet_category2">猫
                            </label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" style="width:70%;display:inline;" placeholder="市场价格" name="market_price" value="{{ $service->market_price }}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">本店价格</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" style="width:70%;display:inline;" placeholder="本店价格" name="shop_price" value="{{ $service->shop_price }}"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="col-sm-4 radio">
                            <label>
                                <input type="radio" name="is_on_sale" value="1" id="is_on_sale1">是
                            </label>
                        </div>
                        <div class="col-sm-6 radio">
                            <label>
                                <input type="radio" name="is_on_sale" value="0" id="is_on_sale0">否
                            </label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" style="width:70%;display:inline;" placeholder="数值越大排名越前" id="sort_order" name="sort_order" value="{{ $service->sort_order }}">
                    </div>
                </div>
                <div class="form-group">
...
@section('script')
    ...
    <script>
        $(function(){
            /***单选按钮*/
            $('#pet_category{{$service->pet_category}}').attr('checked','true');//是否显示
            $('#is_on_sale{{$service->is_on_sale}}').attr('checked','true');//是否显示
            /***编写Javascript表单验证区域*/
            $("#form-add").validate({
                rules:{//规则
                    service_name:{
